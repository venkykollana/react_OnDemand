...
class App extends Component {
  ...
  filterProjectDetailsData = () => {
    const {activeTabId} = this.state
    const filteredDetails = projectsList.filter(
  ...
  render() {
    const filteredProjectDetails = this.filterProjectDetailsData()
    const {activeTabId} = this.state
    ...
    return (
      <div className="app-container">
        ...
        <ul className="project-list-container">
          {filteredProjectDetails.map(projectDetails => (
            <ProjectItem
